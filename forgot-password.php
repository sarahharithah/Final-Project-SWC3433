...
<section class="w3l-inner-banner-main">
 ...
 Forgot Password
            ...
            <p class="tiltle-para ">Forgot your password? Don’t worry! Reset it easily and regain access to your beauty favorites in just a few clicks.</p>
        </div>
</div>
</div>
...
?>
               ...
               <?php } ?> </div>
                <div class="map-content-9 mt-lg-0 mt-4">
                    <h3 style="padding-bottom: 10px;">Reset Your Password and Fill In The Details</h3>
                    <form method="post">
                        <div>
