...
<section class="w3l-inner-banner-main">
 ...
 Change Password
            ...
            <p class="tiltle-para ">Easily update your password to keep your account secure. Visit Setting page to change your password anytime!</p>
        </div>
</div>
</div>
...
?>
                    <div class="cont-top">
                        ...
                        <div class="cont-right">
                            <h6>Call Us</h6>
                            <p class="para"><a href="tel:+6049993312">+<?php  echo $row['MobileNumber'];?></a></p>
                        </div>
                    </div>
