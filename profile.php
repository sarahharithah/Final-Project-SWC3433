...
<html lang="en">
  <head>
    ...
    <title>Salvadora Skin A Beauty Parlour Management System | Signup Page</title>
...
<section class="w3l-inner-banner-main">
 ...
 Profile
            ...
            <p class="tiltle-para ">Create a profile to unlock personalized beauty recommendations and exclusive offers. Stay connected with your favorite products!</p>
        </div>
</div>
</div>
...
?>
                    <div class="cont-top">
                        ...
                        <div class="cont-right">
                            <h6>Call Us</h6>
                            <p class="para"><a href="tel:+6039993312">+<?php  echo $row['MobileNumber'];?></a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            <h6>Email Us</h6>
                            <p class="para"><a href="mailto:salvadoraskin@gmail.com" class="mail"><?php  echo $row['Email'];?></a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
